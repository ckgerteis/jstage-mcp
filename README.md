...
Download `jstage-mcp-3.1.0.mcpb` from the [latest release](https://github.com/ckgerteis/jstage-mcp/releases/latest) and open it; Claude Desktop installs it. One bundle serves Windows, macOS (Apple Silicon and Intel) and Linux. Claude Desktop asks only for a receipts folder at install time.
...
```bash
pip install "git+https://github.com/ckgerteis/jstage-mcp@v3.1.0"
# or, without an environment of your own:
uvx --from "git+https://github.com/ckgerteis/jstage-mcp@v3.1.0" jstage-mcp
```
