...
The latest release on the [releases page](https://github.com/ckgerteis/jstage-mcp/releases) is
...
or email christopher.gerteis@gmail.com with "jstage-mcp security" in the subject. Say which version, how to reproduce, and
